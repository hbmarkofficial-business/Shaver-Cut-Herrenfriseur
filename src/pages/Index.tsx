  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Shaver Cut Herrenfriseur</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Shaver Cut Herrenfriseur in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Shaver Cut Herrenfriseur | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Shaver Cut Herrenfriseur | Premium Barbershop Berlin" />
        <meta
